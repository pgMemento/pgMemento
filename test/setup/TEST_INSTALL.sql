...
BEGIN
  ...
  ASSERT pgm_objects[40] = 'init;text;schema_name text DEFAULT ''public''::text, log_state boolean DEFAULT true, include_new boolean DEFAULT false, trigger_create_table boolean DEFAULT true, except_tables text[] DEFAULT ''{}''::text[]', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[46] = 'log_new_table_state;SETOF void;columns text[], tablename text, schemaname text, table_event_key text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[47] = 'log_old_table_state;SETOF void;columns text[], tablename text, schemaname text, table_event_key text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[48] = 'log_schema_baseline;SETOF void;schemaname text DEFAULT ''public''::text, include_new boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[49] = 'log_table_baseline;SETOF void;table_name text, schema_name text DEFAULT ''public''::text, include_new boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[50] = 'log_table_event;text;event_txid bigint, tablename text, schemaname text, op_type text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[51] = 'log_transaction;trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[52] = 'log_truncate;trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[53] = 'log_update;trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[54] = 'modify_ddl_log_tables;SETOF void;tablename text, schemaname text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[55] = 'modify_row_log;SETOF void;tablename text, schemaname text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[56] = 'move_schema_state;SETOF void;target_schema_name text, source_schema_name text DEFAULT ''public''::text, except_tables text[] DEFAULT ''{}''::text[], copy_data boolean DEFAULT true', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[57] = 'move_table_state;SETOF void;table_name text, target_schema_name text, source_schema_name text, copy_data boolean DEFAULT true', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[58] = 'pkey_schema_state;SETOF void;target_schema_name text, original_schema_name text DEFAULT ''public''::text, except_tables text[] DEFAULT ''{}''::text[]', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[59] = 'pkey_table_state;SETOF void;table_name text, target_schema_name text, original_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[60] = 'recover_audit_version;SETOF void;tid integer, aid bigint, changes jsonb, table_op integer, table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[61] = 'register_audit_table;integer;audit_table_name text, audit_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[62] = 'restore_change;anyelement;during_tid integer, aid bigint, column_name text, INOUT restored_value anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[63] = 'restore_query;text;start_from_tid integer, end_at_tid integer, table_name text, schema_name text DEFAULT ''public''::text, aid bigint DEFAULT NULL::bigint, all_versions boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[64] = 'restore_record;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[65] = 'restore_record_definition;text;tid integer, table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[66] = 'restore_record_definition;text;start_from_tid integer, end_at_tid integer, table_log_id integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[67] = 'restore_records;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[68] = 'restore_recordset;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text DEFAULT ''public''::text, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[69] = 'restore_recordsets;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text DEFAULT ''public''::text, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[70] = 'restore_schema_state;SETOF void;start_from_tid integer, end_at_tid integer, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[71] = 'restore_table_state;SETOF void;start_from_tid integer, end_at_tid integer, original_table_name text, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[72] = 'restore_value;anyelement;until_tid integer, aid bigint, column_name text, INOUT restored_value anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[73] = 'revert_distinct_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[74] = 'revert_distinct_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[75] = 'revert_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[76] = 'revert_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[77] = 'schema_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[86] = 'table_create_post_trigger_full;event_trigger', 'Error: Expected different function and/or arguments';
