...
BEGIN
  ...
  ASSERT array_length(pgm_objects,1) = 67, 'Error: Incorrect number of stored procedures!';
  ...
  ASSERT pgm_objects[2] = 'create_restore_template;SETOF void;tid integer, template_name text, table_name text, schema_name text, preserve_template integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[12] = 'delete_table_event_log;SETOF integer;tid integer, table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[13] = 'delete_txid_log;integer;tid integer', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[25] = 'generate_log_entries;SETOF jsonb;start_from_tid integer, end_at_tid integer, table_name text, schema_name text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[26] = 'generate_log_entry;jsonb;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[27] = 'get_ddl_from_context;text;stack text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[28] = 'get_max_txid_to_audit_id;integer;aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[29] = 'get_min_txid_to_audit_id;integer;aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[30] = 'get_txid_bounds_to_table;record;table_name text, schema_name text DEFAULT ''public''::text, OUT txid_min integer, OUT txid_max integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[31] = 'get_txids_to_audit_id;SETOF integer;aid bigint', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[35] = 'jsonb_populate_value;anyelement;jsonb_log jsonb, column_name text, INOUT template anyelement', , 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[39] = 'log_table_event;integer;event_txid bigint, table_oid oid, op_type text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[40] = 'log_table_state;SETOF void;table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[41] = 'log_transaction;trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[42] = 'log_truncate;trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[43] = 'log_update;trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[44] = 'modify_ddl_log_tables;SETOF void;tablename text, schemaname text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[45] = 'move_schema_state;SETOF void;target_schema_name text, source_schema_name text DEFAULT ''public''::text, except_tables text[] DEFAULT ''{}''::text[], copy_data integer DEFAULT 1', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[46] = 'move_table_state;SETOF void;table_name text, target_schema_name text, source_schema_name text, copy_data integer DEFAULT 1', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[47] = 'pkey_schema_state;SETOF void;target_schema_name text, original_schema_name text DEFAULT ''public''::text, except_tables text[] DEFAULT ''{}''::text[]', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[48] = 'pkey_table_state;SETOF void;table_name text, target_schema_name text, original_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[49] = 'recover_audit_version;SETOF void;tid integer, aid bigint, changes jsonb, table_op integer, table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[52] = 'restore_query;text;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint DEFAULT NULL::bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[53] = 'restore_schema_state;SETOF void;start_from_tid integer, end_at_tid integer, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[54] = 'restore_table_state;SETOF void;start_from_tid integer, end_at_tid integer, original_table_name text, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[55] = 'restore_value;anyelement;until_tid integer, aid bigint, column_name text, INOUT restored_value anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[56] = 'revert_distinct_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[57] = 'revert_distinct_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[58] = 'revert_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[59] = 'revert_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[60] = 'schema_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[61] = 'sequence_schema_state;SETOF void;target_schema_name text, original_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[62] = 'table_alter_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[63] = 'table_alter_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[64] = 'table_create_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[65] = 'table_drop_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[66] = 'table_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[67] = 'unregister_audit_table;SETOF void;audit_table_name text, audit_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
END
$$
LANGUAGE plpgsql;
