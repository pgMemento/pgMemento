...
BEGIN
  ...
  ASSERT pgm_objects[35] = 'log_delete;trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[36] = 'log_insert;trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[37] = 'log_schema_state;SETOF void;schemaname text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[38] = 'log_table_event;integer;event_txid bigint, table_oid oid, op_type text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[48] = 'recover_audit_version;SETOF void;tid integer, aid bigint, changes jsonb, table_op integer, table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[50] = 'restore_query;text;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint DEFAULT NULL::bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[51] = 'restore_schema_state;SETOF void;start_from_tid integer, end_at_tid integer, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[52] = 'restore_table_state;SETOF void;start_from_tid integer, end_at_tid integer, original_table_name text, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[53] = 'revert_distinct_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[54] = 'revert_distinct_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[55] = 'revert_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[56] = 'revert_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
