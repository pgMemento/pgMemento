...
BEGIN
  ...
  ASSERT array_length(pgm_objects,1) = 65, 'Error: Incorrect number of stored procedures!';
  ...
  ASSERT pgm_objects[13] = 'delete_table_event_log;SETOF integer;tid bigint, table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[14] = 'delete_txid_log;bigint;t_id bigint', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[26] = 'generate_log_entries;SETOF jsonb;start_from_tid bigint, end_at_tid bigint, table_name text, schema_name text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[27] = 'generate_log_entry;jsonb;start_from_tid bigint, end_at_tid bigint, table_name text, schema_name text, aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[28] = 'get_ddl_from_context;text;stack text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[29] = 'get_max_txid_to_audit_id;bigint;aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[30] = 'get_min_txid_to_audit_id;bigint;aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[31] = 'get_txid_bounds_to_table;record;table_name text, schema_name text DEFAULT ''public''::text, OUT txid_min bigint, OUT txid_max bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[32] = 'get_txids_to_audit_id;SETOF bigint;aid bigint', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[36] = 'log_ddl_event;integer;table_name text, schema_name text, op_type integer, op_text text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[49] = 'recover_audit_version;SETOF void;tid bigint, aid bigint, changes jsonb, table_op integer, table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[51] = 'restore_query;text;start_from_tid bigint, end_at_tid bigint, table_name text, schema_name text, aid bigint DEFAULT NULL::bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[52] = 'restore_schema_state;SETOF void;start_from_tid bigint, end_at_tid bigint, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[53] = 'restore_table_state;SETOF void;start_from_tid bigint, end_at_tid bigint, original_table_name text, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[54] = 'revert_distinct_transaction;SETOF void;tid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[55] = 'revert_distinct_transactions;SETOF void;start_from_tid bigint, end_at_tid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[56] = 'revert_transaction;SETOF void;tid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[57] = 'revert_transactions;SETOF void;start_from_tid bigint, end_at_tid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[58] = 'schema_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[59] = 'sequence_schema_state;SETOF void;target_schema_name text, original_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[60] = 'table_alter_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[61] = 'table_alter_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[62] = 'table_create_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[63] = 'table_drop_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[64] = 'table_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[65] = 'unregister_audit_table;SETOF void;audit_table_name text, audit_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
END;
$$
LANGUAGE plpgsql;
