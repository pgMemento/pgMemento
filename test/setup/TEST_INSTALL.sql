...
BEGIN
  ...
  ASSERT array_length(pgm_objects,1) = 93, 'Error: Incorrect number of stored procedures!';
  ...
  ASSERT pgm_objects[62] = 'recover_audit_version;SETOF void;tid integer, aid bigint, changes jsonb, table_op integer, tab_name text, tab_schema text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[64] = 'reinit;text;schemaname text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text, log_old_data boolean DEFAULT true, log_new_data boolean DEFAULT false, trigger_create_table boolean DEFAULT false, except_tables text[] DEFAULT ''{}''::text[]', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[65] = 'restore_change;anyelement;during_tid integer, aid bigint, column_name text, INOUT restored_value anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[66] = 'restore_query;text;start_from_tid integer, end_at_tid integer, table_name text, schema_name text DEFAULT ''public''::text, aid bigint DEFAULT NULL::bigint, all_versions boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[67] = 'restore_record;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[68] = 'restore_record_definition;text;tid integer, table_name text, schema_name text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[69] = 'restore_record_definition;text;start_from_tid integer, end_at_tid integer, table_log_id integer, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[70] = 'restore_records;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[71] = 'restore_recordset;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text DEFAULT ''public''::text, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[72] = 'restore_recordsets;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text DEFAULT ''public''::text, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[73] = 'restore_schema_state;SETOF void;start_from_tid integer, end_at_tid integer, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[74] = 'restore_table_state;SETOF void;start_from_tid integer, end_at_tid integer, original_table_name text, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[75] = 'restore_value;anyelement;until_tid integer, aid bigint, column_name text, INOUT restored_value anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[76] = 'revert_distinct_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[77] = 'revert_distinct_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[78] = 'revert_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[79] = 'revert_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[80] = 'schema_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[81] = 'sequence_schema_state;SETOF void;target_schema_name text, original_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[82] = 'split_table_from_query;record;INOUT query text, OUT audit_table_name text, OUT audit_schema_name text, OUT audit_table_log_id integer, OUT audit_id_column_name text, OUT audit_old_data boolean', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[83] = 'start;text;schemaname text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text, log_old_data boolean DEFAULT true, log_new_data boolean DEFAULT false, trigger_create_table boolean DEFAULT false, except_tables text[] DEFAULT ''{}''::text[]', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[84] = 'stop;text;schemaname text DEFAULT ''public''::text, except_tables text[] DEFAULT ''{}''::text[]', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[85] = 'table_alter_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[86] = 'table_alter_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[87] = 'table_create_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[88] = 'table_drop_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[89] = 'table_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[90] = 'trim_outer_quotes;text;quoted_string text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[91] = 'unregister_audit_table;SETOF void;audit_table_name text, audit_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[92] = 'update_key;SETOF bigint;aid bigint, path_to_key_name text[], old_value anyelement, new_value anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[93] = 'version;record;OUT full_version text, OUT major_version integer, OUT minor_version integer, OUT revision integer, OUT build_id text', 'Error: Expected different function and/or arguments';
END;
$$
LANGUAGE plpgsql;
