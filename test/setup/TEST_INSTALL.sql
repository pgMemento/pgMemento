...
BEGIN
  ...
  ASSERT array_length(pgm_objects,1) = 68, 'Error: Incorrect number of stored procedures!';
  ...
  ASSERT pgm_objects[3] = 'create_restore_template;SETOF void;tid integer, template_name text, table_name text, schema_name text, preserve_template integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[4] = 'create_schema_audit;SETOF void;schema_name text DEFAULT ''public''::text, log_state integer DEFAULT 1, except_tables text[] DEFAULT ''{}''::text[]', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[6] = 'create_schema_event_trigger;SETOF void;trigger_create_table integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[8] = 'create_table_audit;SETOF void;table_name text, schema_name text DEFAULT ''public''::text, log_state integer DEFAULT 1', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[26] = 'generate_log_entries;SETOF jsonb;start_from_tid integer, end_at_tid integer, table_name text, schema_name text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[27] = 'generate_log_entry;jsonb;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[40] = 'log_table_event;integer;event_txid bigint, table_oid oid, op_type text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[50] = 'recover_audit_version;SETOF void;tid integer, aid bigint, changes jsonb, table_op integer, table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[52] = 'restore_change;anyelement;during_tid integer, aid bigint, column_name text, INOUT restored_value anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[53] = 'restore_query;text;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, aid bigint DEFAULT NULL::bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[54] = 'restore_schema_state;SETOF void;start_from_tid integer, end_at_tid integer, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[55] = 'restore_table_state;SETOF void;start_from_tid integer, end_at_tid integer, original_table_name text, original_schema_name text, target_schema_name text, target_table_type text DEFAULT ''VIEW''::text, update_state integer DEFAULT 0', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[56] = 'restore_value;anyelement;until_tid integer, aid bigint, column_name text, INOUT restored_value anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[57] = 'revert_distinct_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[58] = 'revert_distinct_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[59] = 'revert_transaction;SETOF void;tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[60] = 'revert_transactions;SETOF void;start_from_tid integer, end_at_tid integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[61] = 'schema_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[62] = 'sequence_schema_state;SETOF void;target_schema_name text, original_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[63] = 'table_alter_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[64] = 'table_alter_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[65] = 'table_create_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[66] = 'table_drop_post_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[67] = 'table_drop_pre_trigger;event_trigger', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[68] = 'unregister_audit_table;SETOF void;audit_table_name text, audit_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
END
$$
LANGUAGE plpgsql;
