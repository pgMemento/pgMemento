...
BEGIN
  ...
  ASSERT pgm_objects[26] = 'get_ddl_from_context;text;stack text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[27] = 'get_max_txid_to_audit_id;integer;aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[28] = 'get_min_txid_to_audit_id;integer;aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[29] = 'get_txid_bounds_to_table;record;table_name text, schema_name text DEFAULT ''public''::text, OUT txid_min integer, OUT txid_max integer', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[30] = 'get_txids_to_audit_id;SETOF integer;aid bigint', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[31] = 'index_schema_state;SETOF void;target_schema_name text, original_schema_name text DEFAULT ''public''::text, except_tables text[] DEFAULT ''{}''::text[]', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[32] = 'index_table_state;SETOF void;table_name text, target_schema_name text, original_schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[33] = 'jsonb_merge;jsonb;jsonb', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[34] = 'jsonb_populate_value;anyelement;jsonb_log jsonb, column_name text, INOUT template anyelement', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[35] = 'log_column_state;SETOF void;e_id integer, columns text[], table_name text, schema_name text DEFAULT ''public''::text', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[45] = 'move_schema_state;SETOF void;target_schema_name text, source_schema_name text DEFAULT ''public''::text, except_tables text[] DEFAULT ''{}''::text[], copy_data boolean DEFAULT true', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[46] = 'move_table_state;SETOF void;table_name text, target_schema_name text, source_schema_name text, copy_data boolean DEFAULT true', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[54] = 'restore_record_definition;text;until_tid integer, table_name text, schema_name text', 'Error: Expected different function and/or arguments';
  ASSERT pgm_objects[55] = 'restore_recordset;SETOF record;start_from_tid integer, end_at_tid integer, table_name text, schema_name text, jsonb_output boolean DEFAULT false', 'Error: Expected different function and/or arguments';
