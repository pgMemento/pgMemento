...
BEGIN
  ...
  ASSERT pgm_objects[4] = 'create_schema_audit;SETOF void;schemaname text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text, log_old_data boolean DEFAULT true, log_new_data boolean DEFAULT false, log_state boolean DEFAULT false, trigger_create_table boolean DEFAULT false, except_tables text[] DEFAULT ''{}''::text[], skip_schema_event_triggers boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[6] = 'create_schema_event_trigger;SETOF void;trigger_create_table boolean DEFAULT false, skip_schema_event_triggers boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[8] = 'create_table_audit;SETOF void;tablename text, schemaname text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text, log_old_data boolean DEFAULT true, log_new_data boolean DEFAULT false, log_state boolean DEFAULT false, skip_schema_event_triggers boolean DEFAULT false', 'Error: Expected different function and/or arguments';
  ...
  ASSERT pgm_objects[65] = 'reinit;text;schemaname text DEFAULT ''public''::text, audit_id_column_name text DEFAULT ''pgmemento_audit_id''::text, log_old_data boolean DEFAULT true, log_new_data boolean DEFAULT false, trigger_create_table boolean DEFAULT false, except_tables text[] DEFAULT ''{}''::text[], skip_schema_event_triggers boolean DEFAULT false', 'Error: Expected different function and/or arguments';
