...
BEGIN
  ...
  ASSERT pgm_objects[93] = 'version;record;OUT full_version text, OUT major_version integer, OUT minor_version integer, OUT build_id text', 'Error: Expected different function and/or arguments';
END;
$$
LANGUAGE plpgsql;
