...
BEGIN
  ...
  ASSERT upper(tid_range) = test_transaction, 'Error: End transaction id % does not match the id % of ALTER TABLE RENAME event', upper(tid_range), test_transaction;
  ...
  ASSERT lower(tid_range) = test_transaction, 'Error: Starting transaction id % does not match the id % of ALTER TABLE RENAME event', lower(tid_range), test_transaction;
