...
psql -U postgres postgres -c 'drop database if exists pgmemento_test;'
psql -U postgres postgres -c 'create database pgmemento_test;'

cd /home/pgmemento;
psql -U postgres pgmemento_test -f /home/pgmemento/extension/tests/TEST.sql
